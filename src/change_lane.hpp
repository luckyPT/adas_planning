...
void init_scene(){
    ...
    std::vector<Point> lane1_pts = {{car_center_x, car_center_y + 20000}, {car_center_x, car_center_y - 2000}};
    std::vector<Point> lane2_pts = {{car_center_x + 350, car_center_y + 20000}, {car_center_x + 350, car_center_y - 2000}};
